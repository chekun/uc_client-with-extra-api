...
function uc_user_rename($old_username, $new_username) {
	return call_user_func(UC_API_FUNC, 'user', 'rename', array('old_username' => $old_username, 'new_username' => $new_username));
}
